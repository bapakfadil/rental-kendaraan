<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <x-input-label for="unique_code" :value="__('Unique Code')" />
            <x-text-input id="unique_code" class="block mt-1 w-full" type="text" name="unique_code" value="{{ $unique_code }}" readonly />
        </div>
